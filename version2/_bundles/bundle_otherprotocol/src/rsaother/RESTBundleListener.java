...
import rsaother.util.EndpointDescriptionParser;

/*
 * Parse XML endpoint descriptions for importing endpoints of started bundles
 */
public class RESTBundleListener implements BundleListener {

	private final RESTServiceAdmin rsa;

	private final Map<Bundle, List<ImportRegistration>> importRegistrations;

	public RESTBundleListener(RESTServiceAdmin rsa) {
		this.rsa = rsa;
